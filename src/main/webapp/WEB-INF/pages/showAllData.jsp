...
<body
	...
	<div class="container mb-3 mt-3">
		<font class="myTextStyle" face="Showcard Gothic" size="5"
			style="color: #00ffaca6;">WARLIONS</font><br />
		<!--  margin bottom and margin top == 3-->
		<a href="showAllEmployees"> <img src="Images/coolguy.jpg"
			style="height: 180px">
		</a> <a href="register.jsp">
			<button type="button" class="btn btn-success">Register/Sign
				Up</button>
		</a> <a href="logout"> <!-- Simple Button --> <!-- <button>Show Employees</button> -->
			<button type="button" class="btn btn-warning">LogOut</button>
		</a> <br /> <br /> <span style="font-size: 18px; color: red;">${message}
		</span>
		<hr />
		<!-- **************************************************************** -->
		<!-- **************************************************************** -->
 ...
 -->
		...
		<table id="myTable"
			class="table table-striped table-bordered sortable myFormStyle"
			style="color: white">
			...
			<tbody>
				...
				<c:forEach items="${employeeList}" var="entity">
					...
					<tr>
						...
						<td><img src="image?eid=${entity.eid}" style="height: 100px;">
							<a href="uploadPhoto?eid=${entity.eid}">
								<button class="myBtn uploadBtn">
						...
						<td><c:if
								test="${entity.email != sessionScope.userData.email}">

								<a href="deletePerson?eid=${entity.eid}	">
								...
								<a href="editPerson?eid=${entity.eid}">
									<button class="myBtn editBtn">
