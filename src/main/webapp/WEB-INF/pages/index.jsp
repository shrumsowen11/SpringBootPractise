	...
	<div class="container mb-3 mt-3">
	 ...
	 <div class="row "> 
			...
			<div class="col-md-8 col-sm-8 col-xs-12 ">
						<img src="Images/coolguy.jpg" height = 200px; width = 200px; style=" margin-left: auto; display:block; margin-right: auto;  width = 50%; "><br />
				...
				<div class="form-group" style=" width: 100%">
					...
					<form action="login" class = "myFormStyle" method="post">
						...
						<label for="email" style="color:white"> <b>Email Address or Username* </b></label>
